...
STEERING_RIGHT_PWM = 170        #pwm value for full right steering
# 
# #THROTTLE
...
# DONKEY_GYM = False
# DONKEY_SIM_PATH = "path to sim" #"/home/tkramer/projects/sdsandbox/sdsim/build/DonkeySimLinux/donkey_sim.x86_64" when racing on virtual-race-league use "remote", or user "remote" when you want to start the sim
 manually first.
